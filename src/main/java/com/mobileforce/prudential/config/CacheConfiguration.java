package com.mobileforce.prudential.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("prudential");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("prudential");
        ...
        config.getMapConfigs().put("com.mobileforce.prudential.domain.*", initializeDomainMapConfig(jHipsterProperties));
